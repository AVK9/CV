import{c as p,n as b,u as n,h as u,j as e,r as f,a as m,d,g as $,B as y,S as j}from"./index-e37d8310.js";import{F as h,A as v,B as k,T as w,C,a as L,L as M,b as N}from"./Filters-e991c76e.js";const S=t=>t.adverts.adverts,A=t=>t.filter.filter,E=t=>t.filter.type,F=t=>t.filter.equipment,B=t=>t.adverts.isLoading,T=t=>t.adverts.error,V=t=>t.adverts.pageAnd,P=p([S,A],(t,a)=>a.length>0?t.filter(s=>s.location.toLowerCase().includes(a.toLowerCase())):t),q=p([P,E],(t,a)=>a.length>0?t.filter(s=>s.form.includes(a)):t),z=p([q,F],(t,a)=>a.length>0?t.filter(s=>a.every(o=>s.details[o]!==0&&s.transmission==="automatic")):t);b.div`
  display: flex;
