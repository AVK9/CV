import{c as i,n as x,r as g,a as p,b as o,g as h,B as j,j as t,L as f,S as L}from"./index-02ba4d7b.js";import{A as v,F as u,B as y,T as A,C as E,a as S,L as C,b as F}from"./Filters-8782536c.js";const b=e=>e.adverts.adverts,T=e=>e.filter.filter,V=e=>e.filter.type,w=e=>e.filter.equipment,B=e=>e.adverts.isLoading,P=e=>e.adverts.error,k=e=>e.adverts.pageAnd,q=i([b,T],(e,s)=>s.length>0?e.filter(r=>r.location.toLowerCase().includes(s.toLowerCase())):e),D=i([q,V],(e,s)=>s.length>0?e.filter(r=>r.form.includes(s)):e),I=i([D,w],(e,s)=>s.length>0?e.filter(r=>s.every(c=>r.details[c]!==0&&r.transmission==="automatic")):e);x.div`
  display: flex;
